 ...
 *
 * Hash routing: #scene=N jumps directly. Combine with &run for headless screenshots
 * of scenes that gate animation behind a button. */

(function () {
  const SCENE_TITLES = [
    "",                                       // 0: hero
    "Two numbers per image",
    "A picture is just a vector",
    "PCA returns the shapes",
    "Reconstruction is addition",
    "Five shapes, five eigen-images",
    "One shape is a fiction",
    "When colors correlate, eigenvectors rotate",
    "Three lessons"
  ];
